...
public class User {
	...
	public boolean canAfford(Propuesta propuesta) {
		return propuesta.getCost() <= this.coins;
	}

	public boolean canAttend(Propuesta propuesta) {
		return propuesta.getDuration() <= this.time;
	}
